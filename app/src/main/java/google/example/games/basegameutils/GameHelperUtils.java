...
class GameHelperUtils {
    ...
    private static final int[] RES_IDS = new int[]{R.string.gamehelper_unknown_error, R.string.gamehelper_sign_in_failed, R.string.gamehelper_app_misconfigured, R.string.gamehelper_license_failed};
