package google.example.games.basegameutils;
...
public class GameHelper implements ConnectionCallbacks, OnConnectionFailedListener {
    ...
    public static class SignInFailureReason {
        ...
        public String toString() {
            String str;
            StringBuilder append = new StringBuilder("SignInFailureReason(serviceErrorCode:").append(GameHelperUtils.errorCodeToString(this.mServiceErrorCode));
    ...
    public Builder createApiClientBuilder() {
        ...
        if ((this.mRequestedClients & CLIENT_APPSTATE) != 0) {
    ...
    public void onActivityResult(int requestCode, int responseCode, Intent intent) {
        ...
        debugLog(stringBuilder.append(str).append(", resp=").append(GameHelperUtils.activityResponseCodeToString(responseCode)).toString());
        if (requestCode != RC_RESOLVE) {
